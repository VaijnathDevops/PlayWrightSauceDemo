---
description: Create or extend Page Object classes for the application under test in TestProject1/Pages/
---

Use the `pom-engineer` agent to create or extend Page Object classes in `TestProject1/Pages/`, following the `page-object-model-generator` skill and the project `CLAUDE.md` conventions.

The agent will:
1. Audit `TestProject1/Pages/` — extend existing classes rather than creating duplicates
